...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 2. read request success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 3. parse request success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 5. open server success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 6. send request to server success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 7. send header success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 9. get response and send header success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
    /* get body */
...
#ifdef DEBUG
    P(&p);
    printf("[%ul]: 10. send response body success\n", pthread_self());
    fflush(stdout);
    V(&p);
#endif
    close(fd);
